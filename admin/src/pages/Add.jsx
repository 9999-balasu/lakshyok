  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className=''>
        ...
        <select onChange={(e)=> setCategory(e.target.value)} className='w-full max-w-[500px] px-3 py-2 border border-gray-300 rounded'>
      ...
      <div className=''>
        ...
        <select  onChange={(e)=> setSubCategory(e.target.value)} className='w-full max-w-[500px] px-3 py-2 border border-gray-300 rounded'>
      ...
      <div className=''>
        ...
        <input onChange={(e)=> setPrice(e.target.value)} value={price}
          className='w-full max-w-[500px] sm:w-[120px] px-3 py-2 border border-gray-300 rounded'
          type='number'
          placeholder='25'
        />
      </div>
